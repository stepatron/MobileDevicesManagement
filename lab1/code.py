...
#===========================================================================================================
phone_number = input('Введите номер телефона (или оставьте пустым для номера по умолчанию): ')
...
variables = input('''Введите следующие параметры через пробел (или оставьте пустыми для данных по умолчанию)
